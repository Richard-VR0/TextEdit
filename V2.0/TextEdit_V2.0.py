...
class Text:
    ...
    def settings(self):
        ...
        label = tk.Label(setting, text="Choo tema:")
        label.pack()
        ...
        label = tk.Label(setting, text="Seleziona dimensione:")
        label.pack()
        ...
        #SAVING BUTTOM
        save = tk.Button(setting, text="Salva impostazioni", width=18, command=getselecteditem)
        save.pack()
        #END BUTTON
    #END SETTINGS PAGE
